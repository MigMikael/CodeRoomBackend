  ...
  .controller('Ctrl', ['$scope', '$window', '$http', '$sce','$rootScope','$localStorage',
    function($scope, $window, $http, $sce,$rootScope,$localStorage) {
      ...
      $scope.initFromText = function(text) {
        ...
        if($rootScope.statusAnnouncement === "addAnnouncement"){
            $rootScope.announcement_content = null;
        }else if($rootScope.statusAnnouncement === "editAnnouncement" && $rootScope.announcement_content!==undefined && $rootScope.announcement_content !== null){
            $scope.initFromText($rootScope.announcement_content);
        }
