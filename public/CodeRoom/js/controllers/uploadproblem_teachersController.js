app.controller('uploadproblem_teachersController',function($scope, $sce, $http, Upload, $timeout,$stateParams,lesson_teachers,$rootScope,$localStorage) {
    $scope.isNav = false;
    $scope.isAlert = false;
    ...
    function getLesson() {
        ...
        lesson_teachers.getLesson_students($localStorage.lesson_id)
